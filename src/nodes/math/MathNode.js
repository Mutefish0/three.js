	...
	generate(builder, output) {
		...
		if (method === MathNode.TRANSFORM_DIRECTION) {
			...
			if (method === MathNode.CROSS || method === MathNode.MOD) {
				...
				if (c.isConstNode) {
					if (!!c.value) {
						return b.build(builder, inputType);
					} else {
...
MathNode.DFDX = "dFdx";
MathNode.DFDY = "dFdy";
MathNode.dpdxFine = "dpdxFine";
MathNode.dpdyFine = "dpdyFine";
MathNode.dpdx = "dpdx";
MathNode.dpdy = "dpdy";
...
export const inverseSqrt = /*@__PURE__*/ nodeProxy(
	MathNode,
...
export const dpdxFine = /*@__PURE__*/ nodeProxy(MathNode, MathNode.dpdxFine);
export const dpdyFine = /*@__PURE__*/ nodeProxy(MathNode, MathNode.dpdyFine);
export const dpdx = /*@__PURE__*/ nodeProxy(MathNode, MathNode.dpdx);
export const dpdy = /*@__PURE__*/ nodeProxy(MathNode, MathNode.dpdy);
export const round = /*@__PURE__*/ nodeProxy(MathNode, MathNode.ROUND);
export const reciprocal = /*@__PURE__*/ nodeProxy(
	MathNode,
	MathNode.RECIPROCAL
);
...
export const reverseBits = /*@__PURE__*/ nodeProxy(
	MathNode,
	MathNode.reverseBits
);
...
export const difference = /*@__PURE__*/ nodeProxy(
	MathNode,
	MathNode.DIFFERENCE
);
...
export const transformDirection = /*@__PURE__*/ nodeProxy(
	MathNode,
...
export const smoothstep = /*@__PURE__*/ nodeProxy(
	MathNode,
	MathNode.SMOOTHSTEP
);
export const faceForward = /*@__PURE__*/ nodeProxy(
	MathNode,
